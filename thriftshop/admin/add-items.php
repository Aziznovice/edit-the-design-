        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Title: </td>
                    <td>
                        <input type="text" name="title" placeholder="Title of the of your items">
                    </td>
                </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "item-Name-".rand(0000,9999).".".$ext; //New Image Name May Be "items-Name-657.jpg"
                ...
                else
                {
                    ...
                    $_SESSION['add'] = "<div class='error'>Failed to Add your product.</div>";
                    header('location:'.SITEURL.'admin/manage-items.php');
                }
