            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "items-Name-".rand(0000, 9999).'.'.$ext; //THis will be renamed image
                ...
                if($res3==true)
                {
                    //Query Exectued and items Updated
                    $_SESSION['update'] = "<div class='success'>your product is Updated Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-items.php');
                }
                else
                {
                    //Failed to Update items
                    $_SESSION['update'] = "<div class='error'>Failed to Update the product.</div>";
                    header('location:'.SITEURL.'admin/manage-items.php');
                }
